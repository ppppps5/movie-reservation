...
<!DOCTYPE html>
<html>
<title>1st Group Concert Reservation Project</title>
<meta charset="UTF-8">
...
<!-- 로그인 별로 회원은 memberlogin 관리자는 admin로그인으로 이동시킨다 -->
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="#about" class="w3-bar-item w3-button">오시는 길</a>
      <a href="m_login_view.do" class="w3-bar-item w3-button">로그인</a>
    </div>
  </div>
</div>
...
<footer class="w3-center w3-black w3-padding-16">
	<p>All contents Copyright by 2021 Human Inc. all rights reserved<br>
     Contact mail : human@human.com Tel: +82 41 561 1122 
     Fax +82 41 561 1122
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-text-green">1st Group</a></p>
</footer>

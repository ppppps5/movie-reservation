...
<body bgcolor="whitesmoke">
	...
	<div class="container">
		<form method="post" action="modefy.do">
			...
			<table class="table tabe=bordered table-hover"
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" id="bbsTitle" name="bbsTitle" maxLength="30"  value="${dto.bbsTitle }"></td>						
					</tr>
					<tr>
						<td style="width: 110px;"><h5>내용</h5></td>
						<td><input class="form-control" type="text" id="bbsContent"	name="bbsContent" maxLength="300"  value="${dto.bbsContent }">
						</td>
					</tr>
					
					<tr>
					<td style="text-align: left" colspan="3"><input
						class="btn btn-primary pull-right" type="submit" value="수정하기"/></td>

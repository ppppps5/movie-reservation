...
<div class="w3-top">
	<div class="w3-bar w3-white w3-wide w3-padding w3-card">
		...
		<div class="w3-right w3-hide-small">
			<a href="/concertProject/main.do" class="w3-bar-item w3-button">메인으로</a> 
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> 정회원</p>
...
<!-- Accordion -->
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-row-padding">
        ...
        <span class="w3-right w3-opacity">빠른 시일 내로 답변드리겠습니다</span>
        <h4>예약 확인</h4><br>
        <hr class="w3-clear">
        <table class="table">
			    <thead>
			...
			<tr>
			<td><a href="reservation_detail_view.do?id=${sessionScope.id }">${dto.userId }</a></td>
			<td>${dto.cNum }</td><td>${dto.rDate }</td>
			<td>${dto.SNAME}</td>
			</tr>
...
function qnaboard() {
	location.href = "listpage_view.do?id=${sessionScope.id }"; //"bbs/listpage.jsp"
}

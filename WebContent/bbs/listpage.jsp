...
<!-- Accordion -->
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-row-padding">
        ...
        <button type="button" class="w3-button w3-theme-d2 w3-margin-bottom" style="float:right;"><i class="fa fa-comment" ><a href="BWrite_view.do?id=${sessionScope.id }"></i>  글쓰기</button> 
      </a></div>
